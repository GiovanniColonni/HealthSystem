...
CREATE TABLE `schedule` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'description is used to write notes about the examination ',
  `patientId` int(11) NOT NULL,
  `doctorId` int(11) NOT NULL,
  `date` date NOT NULL,
  `typeExamination` varchar(45) NOT NULL,
  `description` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_schedule_doctor_idx` (`doctorId`),
  KEY `fk_schedule_patient_idx` (`patientId`),
